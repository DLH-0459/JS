...
(function() {
    ...
    <ol style="list-style-type: upper-alpha;">
        <li>
            ...
            <p>What I find most striking about the user who replied to Messer-Kruse is how they were basically like <i>&ldquo;yeah, we lie sometimes, but that&rsquo;s just how we are, lawlz&rdquo;</i> without giving a fuck&mdash;they didn&rsquo;t deny the failure, hide it, or treat it as anything worth apologising for; instead, they explained it as if it were unremarkable and as if everyone should just accept it without question&mdash;because to the people maintaining the system, it is.</p>
