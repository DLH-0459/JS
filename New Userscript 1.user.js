...
(function() {
    ...
    <ol>
        <li>
            ...
            <p>Wikipedia explicitly gives an extremely strong preference for secondary sources and recently published accounts over primary sources. Both of these effectively equate to a requirement that the documentation be as distant as possible from the actual evidence. That is the exact opposite of what an expert will do, so experts are effectively prohibited from using good practice. While Wikipedia&rsquo;s policies do not explicitly forbid direct citations of primary sources, some policies do firmly declare, for example, <a href="http://en.wikipedia.org/wiki/Wikipedia:No_original_research#Primary,_secondary_and_tertiary_sources"><i>&ldquo;<b>do not</b> analyze, synthesize, interpret, or evaluate material found in a primary source yourself; instead, refer to [&lsquo;reliable&rsquo;] (whatever that word means anymore) secondary sources that do so.&rdquo;</i></a> That is the opposite of what experts actually do.</p>

            <p>Not many people would be surprised that this creates problems in history, religion, politics, and other fields that touch on identity or ideology. What&rsquo;s worse is that, even in STEM topics and in more niche but uncontroversial topics, it still fails. In STEM, for example, facts are verifiable and standards exist, but if a journalist who lacks relevant scientific knowledge or expertise and has to meet deadlines publishes a rushed, inaccurate (possibly intentionally so, especially when it comes to environmental issues) summary of a peer-reviewed study, the journalist&rsquo;s summary is what Wikipedia will require people to defer to, and most direct interpretations of the paper itself or attempts to say &ldquo;the article got it wrong; here is what the paper actually says&rdquo; will be dismissed as &ldquo;original research.&rdquo; The lack of safeguards against an incorrect majority means that an article in a major outlet, even if it is completely wrong, would carry more procedural weight than the actual science it (mis)represents. This policy was designed to keep agendas out of articles, but has become weaponised into one of the best ways to push them in.</p>
        </li>
        <li>
            <p><strong>Their core content policies are an appeal to majority.*</strong></p>
            <p>If you look at their policy on <a href="http://en.wikipedia.org/wiki/Wikipedia:Verifiability">&ldquo;Verifiability&rdquo;</a> (again, whatever that word means anymore), you&rsquo;ll see that their threshold for inclusion is whether or not it can be &ldquo;verified&rdquo; by &ldquo;reliable&rdquo; sources, not about whether or not it is true. So if most or all secondary, tertiary, etc. sources repeat a flawed account of something, Wikipedia will perpetuate the flawed account, even if the primary sources are correct. In any case where the majority of sources are incorrect or obsolete, any content that states what is the most true or accurate will be a minority viewpoint, and it will fail verification because prioritising it will be considered &ldquo;giving it undue weight&rdquo; and any interpretation of the correct viewpoints will, again, be dismissed as &ldquo;original research&rdquo; if it came from a primary source. This creates even more room for error:</p>
            <ul>
                <li>
                    <p><strong>Textbook lag:</strong></p>
                    <p>Even in STEM, widely-used media outlets, websites, and textbooks often contain statements and conventions that are oversimplified, wrong, or obsolete, that have been propagated for a long time.* Textbooks are especially problematic, as they often lag behind the most up-to-date research by 10 years or more. Despite this, Wikipedia&rsquo;s sourcing policies work against editors trying to reflect current consensus among experts by citing papers and other primary sources directly, so they often lose to those citing popular websites and news articles.</p>
                </li>
                <li>
                    <p><strong>Circular reporting:</strong></p>
                    <p>Also known as &ldquo;citogenesis,&rdquo; circular reporting is one of the deadliest problems with Wikipedia. It happens when journalists pull content from Wikipedia articles, then at some point the journalists&rsquo; articles are considered &ldquo;reliable sources,&rdquo; and then <i>those news articles get used as references on those Wikipedia articles.</i> Since errors can easily get laundered into a false consensus, Wikipedia and the sources it cites become locked in an infinite loop of self-validation, and media activists and malicious actors can completely manufacture events and viewpoints using this vulnerability.</p>
                </li>
                <li>
                    <p><strong>No mechanisms for reliably weighing the quality of sources:</strong></p>
                    <p>On Wikipedia, a review in a mid-tier journal written in 2003, meta-analysis in a top-tier journal written five years ago, news article written this year, and even some random person&rsquo;s blog (in some cases) would all carry roughly equal weight under their sourcing policies, provided all of them can be considered &ldquo;reliable.&rdquo; But when editors try to weigh which sources are &ldquo;better&rdquo; or &ldquo;more reliable,&rdquo; the outcome is often decided by what, or how many, editors voted or participated in relevant discussions, or by whatever agendas are being pushed by the groups of users and self-appointed Wiki-lawyers or Wiki-police who essentially &ldquo;own&rdquo; certain articles or policies, not by any epistemic standard.</p>
                </li>
            </ul>
        </li>
        <li>
            <p><strong><a href="http://en.wikipedia.org/wiki/Wikipedia:Dispute_resolution">&ldquo;Dispute resolution&rdquo;</a> is an arms race.</strong></p>
            <p>At first glance, Wikipedia&rsquo;s dispute resolution process (WP:DR) looks like an excellent structure for resolving disagreements. If you look deeper, however, you&rsquo;ll find that, in practice, it is actually a graduated escalation ladder&mdash;talk page discussions, requests for comment, noticeboards, mediation, and arbitration&mdash;where each successively higher rung is an increaingly costly and aggressive contest of time, procedural skill, and sheer emotional endurance, and where the winners are decided by whoever is most willing to keep investing, not by whoever is the most grounded in reality. And even if someone is completely unable to wield Wikipedia&rsquo;s policies and years and years of arbitration and bureaucracy as weapons, they can still win, as long as they stop short of genuinely illegal behaviour&mdash;again, not because they were the most correct, but because they <i>outlasted</i> everyone else, regardless of how right or wrong anyone involved actually was.</p>
        </li>
    </ol>
    <hr />
    <p>*&nbsp;Some very important policies in certain areas are really, really bad.** A good example is <a href="https://en.wikipedia.org/wiki/MOS:COMPUNITS">MOS:COMPUNITS</a>, a policy that governs articles on computers by effectively forcing users to use the obsolete &ldquo;customary&rdquo; convention of using SI prefixes (&ldquo;KB,&rdquo; &ldquo;MB,&rdquo; &ldquo;GB,&rdquo; etc.) for binary (power of 1,024) values when the majority of &ldquo;reliable&rdquo; sources do so, while effectively prohibiting the use of the modern terminology (SI prefixes for powers of 1,000) or clearer IEC prefixes (&ldquo;KiB,&rdquo; &ldquo;MiB,&rdquo; &ldquo;GiB,&rdquo; etc.) unless the majority of sources use them that way. This policy is so absolutely awful that it desperately needs a complete rewrite from scratch, since it directly contradicts the entire reason why standards exist in the first place. But this is the policy governing units of bits and bytes&mdash;as such, it affects thousands of articles across an enormous topic within an enormous industry, and where an awful lot of people have an awful lot invested. Fixing even one article that uses the &ldquo;customary&rdquo; convention or editing just one paragraph of this policy in any way are both grounds for a major conflict akin to a second United States Civil War. Fixing <i>every single article</i> on Wiki that does this <i>and</i> rewriting the whole policy from scratch? Forget it. ${desc_x}</p><br />
