...
(function() {
    ...
    <hr />
    <p><span style="background-color: yellow;">*&nbsp;Some very important policies in certain areas are really, really, really bad, even in STEM topics:</span>

    <p><span style="background-color: yellow;"><a href="https://en.wikipedia.org/wiki/MOS:COMPUNITS">MOS:COMPUNITS</a> is the best example I have. This policy governs how file size units should be written in articles about computing: whether the SI units for bytes (&ldquo;kilobyte,&rdquo; &ldquo;megabyte,&rdquo; &ldquo;gigabyte&rdquo;) mean powers of 1,000 or 1,024.</span></p>
