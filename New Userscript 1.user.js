...
(function() {
    ...
    <ol>
        ...
        <li>
            ...
            <p><span style="background-color: yellow;">If you look at their policy on &ldquo;Verifiability&rdquo; (again, whatever that word means anymore), you&rsquo;ll see that their threshold for inclusion is whether or not it can be &ldquo;verified&rdquo; by &ldquo;reliable&rdquo; sources, not about whether or not it is true. So if, for example, a primary source is factually correct about something, but most or all secondary, tertiary, etc. sources repeat a flawed account, Wikipedia will perpetuate the flawed account. Whenever the majority is wrong, any content that states what is the most true or accurate will be a minority viewpoint, and it will fail verification because prioritising it will be considered &ldquo;giving it undue weight&rdquo; and any interpretation of the correct viewpoints will, again, be dismissed as &ldquo;original research&rdquo; if it came from a primary source. This creates even more room for error:</span></p>
            <ul>
                <li>
