...
(function() {
    ...
    <p><span style="background-color: yellow;">I&rsquo;ve seen many people say that the last two points would be an appeal to authority, but that&rsquo;s merely a red herring masquerading as neutrality. Citing the IEC, ISO, BIPM, or NIST on what a standardised unit means is not an appeal to an irrelevant authority; these are the exact institutions whose entire purpose is to answer precisely this kind of question. Saying &ldquo;citing the IEC&rsquo; definition of a kilobyte is just an appeal to authority&rdquo; is like saying &rdquo;citing the Oxford English Dictionary on what a word means is just an appeal to authority.&rdquo; The authority is not incidental to the claim; it <i>is</i> the claim.</span></p>
