...
(function() {
    ...
    <ol>
        ...
        <li>
            ...
            <p><span style="background-color: yellow;">The community pushes the burden of proof onto those who want to use the modern standard terminology, under the completely incorrect, nonsensical, and misleading assumption that defenders of the customary convention hold the default position.</span></p>
        </li>
    </ol>
    ...
    <p><span style="background-color: yellow;"><strong>END RESULT:</strong> I created a Wikipedia account in 2017, and had a mostly good time editing for the next seven years. In 2024, when I discovered this policy, I tried to bring my concerns to the community, only to end up being completely stonewalled like everyone else before me, and after finding out that Wikipedia&rsquo;s problems run far deeper than I thought, I ended up abandoning my account entirely. What ended up happening, when myself and everyone else that tried to point out MOS:COMPUNITS&rsquo; flaws brought our concerns forward, is that all of us almost ended up with our accounts getting banned, because the community insists that our (truthful, necessary) criticisms to this fundamentally broken policy somehow meant that we&rsquo;re all contrarians who just want to be different or crazy, instead of people bringing up valid technical concerns. The way Wikipedia and their model works means that a thousand editors armed with an industry&rsquo;s beliefs and a majority of sources that mirror those beliefs, even if those beliefs include a long-standing, completely unjustifiable resistance towards correcting faulty practices, will somehow be considered more reliable than 10 or so people like me, approaching the question with no axe to grind, and who actually care about accuracy and consistency, going in and redoing things to modern factual standards, and if you try to be revolutionary, you will not win the arbitration process. So we end up with thousands of articles about computers that use conventions which are well-sourced and widely verifiable, but entirely obsolete, and when it comes to Wikipedia&rsquo;s problems, MOS:COMPUNITS is just one small example out of countless others.</span></p>

    <p>Between the misinformation, <span style="background-color: yellow;">poor policies,</span> poor choices of sources, and <span style="background-color: yellow;">(in some cases)</span> entire sections that don&rsquo;t belong or are wholly misleading, there&rsquo;s not a huge amount to salvage on Wikipedia, outside of hard maths/sciences where there are definite, capital-F Facts and <span style="background-color: yellow;">Formulæ</span>.</p>
    `;
