...
(function() {
    ...
    <p>Between the misinformation, poor choices of sources, entire sections that either don&rsquo;t belong or are wholly misleading, <span style="background-color: yellow;">arms-race editor culture, and policies which are often completely nonsensical or contradictory,</span> there&rsquo;s not a huge amount to salvage on Wikipedia outside of hard maths and sciences where there are definite capital-F Facts and Formulæ.</p>
    `;
