...
(function() {
    ...
    <p><span style="background-color: yellow;">MOS:COMPUNITS is a textbook example of institutionalised arrogance, and it is so ass-backwards that it desperately needs to be completely rewritten from scratch. But this policy is about articles on computers&mdash;a topic that is massive in scale, involves a massive industry, a massive number of Wikipedia articles, and a massive number of web pages, and where a massive number of people have a massive amount invested. Fixing even a single section of this policy by yourself is grounds for a conflict akin to a second United States Civil War. Rewriting the whole thing from scratch? Forget it. <i>${x}</i></span></p>

    <p><span style="background-color: yellow;"><strong><span style="display: inline-block; padding-right: 0.05em;">END RESULT</span>:</strong> I created a Wikipedia account in 2017, and had a mostly good time editing for the next seven years. In 2024, when I discovered this policy, I tried to bring my concerns to the community, only to end up drowning in cult-like procedural resistance and condescension from people more interested in rules than actually engaging with my concerns. Shortly afterwards, I found that there are <i>17 entire pages</i> of arguments involving people trying to get the community to fix it, bringing all sorts of concerns (including the ones I brought up), only to be completely stonewalled like I did. I ended up abandoning my account entirely, since I quickly realised that the outcome is almost always predictable&mdash;anyone who attempts to challenge something this entrenched will be treated as a contrarian who just wants to be crazy, and not as someone raising a legitimate concern. Wikipedia&#39;s model basically means that a thousand editors armed with an industry&#39;s beliefs and majority of sources that mirror those beliefs, even if those beliefs include a long-standing, completely unjustified resistance towards correcting faulty practices, will somehow be considered more reliable than 10 or so people like me, approaching the question with no axe to grind, and who actually care about accuracy and consistency, going in and redoing things to modern factual standards, and if you try to be revolutionary, you will not win the arbitration process. So we end up in a situation where thousands of Wikipedia&#39;s articles on computers use conventions which are well-sourced and widely verifiable, but entirely obsolete, and MOS:COMPUNITS is just one small example out of countless others.</span></p>
    `;
