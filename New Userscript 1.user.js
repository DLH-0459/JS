...
(function() {
    ...
    <p><span style="background-color: yellow;">Due to</span> the misinformation, <span style="background-color: yellow;">poor policies,</span> and poor choices of sources, there&rsquo;s not a huge amount to salvage on Wikipedia, outside of hard maths and sciences where there are definite, capital-F Facts and Formulæ.</p>
    `;
